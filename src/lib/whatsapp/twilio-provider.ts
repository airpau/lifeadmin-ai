...
/**
 * Sanitise a single value before it lands in Twilio's ContentVariables
 * JSON. Twilio's WhatsApp template path rejects (21656 "The Content
 * Variables parameter is invalid") any value that contains:
 *   - newlines (verified 2026-05-29 with the morning brief)
 *   - tabs
 *   - 4+ consecutive spaces (verified 2026-06-07 with Paul's
 *     "Lisagroom New     Ef Hoddesdon" sub provider name)
 *   - certain control characters
 *
 * We collapse all of those down to a single space and trim. Done at the
