...
// Static-import: dynamic `await import('@/lib/whatsapp')` fails to resolve
// under Turbopack (Next 16.2). Same regression hit dispatch.ts; static
// import sidesteps it and is functionally identical.
