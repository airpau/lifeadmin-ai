...
async function recategoriseTransactions(
  ...
  // category wisdom against the canonical parent category. Fire-and-
  // forget — never block the bot reply.
  void bumpUserIntelligence(supabase, userId, parentCategory);
