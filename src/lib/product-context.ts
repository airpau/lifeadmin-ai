...
9. Email Inbox Scanning
   ...
   - Scan depth is 90 days of email history on every plan, including Essential and Pro. Never tell a user a paid plan reads further back than that.
   ...
   - Plan access: Free gets one scan per 30 days. Essential gets monthly re-scans. Pro gets unlimited scans. What differs by plan is how OFTEN you can scan and how many inboxes you can connect, not how far back a scan reads.
