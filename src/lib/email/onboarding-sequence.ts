...
const tipBox = `background:#162544;border-radius:12px;padding:16px 20px;margin:20px 0;border-left:3px solid #34d399;`;
...
const ctaSecondary = `display:inline-block;background:#1e3a5f;color:#e2e8f0;font-weight:600;font-size:14px;padding:12px 24px;border-radius:6px;text-decoration:none;margin:8px 0 8px 12px;border:2px solid #34d399;`;
...
const stepNum = `display:inline-block;width:28px;height:28px;background:#34d399;color:#0a1628;font-weight:700;font-size:14px;border-radius:50%;text-align:center;line-height:28px;margin-right:10px;`;
const badge = `display:inline-block;background:#34d399;color:#0a1628;font-weight:700;font-size:11px;padding:3px 10px;border-radius:6px;letter-spacing:0.05em;text-transform:uppercase;`;
...
<div style="${wrap}">
  ...
  <div style="${body}">
    ...
    <div style="${tipBox}">
      <p style="color:#34d399;font-weight:700;margin:0 0 6px;font-size:12px;text-transform:uppercase;letter-spacing:0.5px;">Did you know?</p>
...
<div style="${wrap}">
  ...
  <div style="${body}">
    ...
    <div style="${tipBox}">
      <p style="color:#34d399;font-weight:700;margin:0 0 6px;font-size:12px;text-transform:uppercase;letter-spacing:0.5px;">Real example</p>
