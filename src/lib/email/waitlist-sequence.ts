...
const wrap = `font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;max-width:600px;margin:0 auto;background:#0a1628;`;
const header = `background:#0a1628;padding:28px 32px 20px;border-bottom:1px solid #1e293b;`;
...
const box = `background:#162544;border-radius:10px;padding:20px 24px;margin:20px 0;border-left:3px solid #34d399;`;
const cta = `display:inline-block;background:#34d399;color:#0a1628;font-weight:700;font-size:15px;padding:13px 26px;border-radius:6px;text-decoration:none;margin:8px 0;`;
