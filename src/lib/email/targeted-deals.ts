  ...
  const opportunityRows = score.topOpportunities.map((opp) => `
    <tr>
      ...
      <td style="padding: 16px 20px; border-bottom: 1px solid #1e293b; text-align: right; vertical-align: top;">
        ...
        <a href="https://paybacker.co.uk/dashboard/deals" style="display: inline-block; margin-top: 8px; background: #34d399; color: #0a1628; padding: 6px 14px; border-radius: 6px; text-decoration: none; font-weight: 700; font-size: 12px;">COMPARE</a>
      </td>
    </tr>
  `).join('');
...
<body style="margin: 0; padding: 0; background-color: #f8fafc; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto;">
    ...
    <div style="background: #0a1628; border-top: 2px solid ${score.tier === 'critical' ? '#ef4444' : '#34d399'}; margin: 0 24px; border-radius: 0 0 16px 16px;">
    ...
    <div style="padding: 28px; text-align: center;">
      <a href="https://paybacker.co.uk/dashboard/deals" style="display: inline-block; background: #34d399; color: #0a1628; padding: 16px 40px; border-radius: 6px; text-decoration: none; font-weight: 800; font-size: 15px;">VIEW YOUR DEALS</a>
    </div>

    <!-- Score breakdown -->
    <div style="margin: 0 24px 24px; background: #0a1628; border: 1px solid #1e293b; border-radius: 12px;">
