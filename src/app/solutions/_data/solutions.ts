 ...
 *
 * Lives outside page.tsx so it is a single source of truth for both the
 * route (generateStaticParams / generateMetadata / render) and
 * src/app/sitemap.ts. Adding a solution here automatically adds the URL
 * to the sitemap, llms.txt and llms-full.txt.
 */
import type { ComponentType, SVGProps } from "react";
import { Shield, Zap, ScanSearch, CreditCard, Plane, BarChart3, Mail, Bell } from "lucide-react";
...
export const PAGES: Record<string, SolutionPage> = {
  'energy-refunds': {
    slug: 'energy-refunds',
...
/** Every solution slug, in declaration order. Consumed by the sitemap. */
export const SOLUTION_SLUGS: string[] = Object.keys(PAGES);
