/**
 * Deal category content for /deals/[category].
 *
 * Lives outside page.tsx so the category list is a single source of
 * truth for the route and for src/app/sitemap.ts.
 */
...
/** Every deal category slug, in declaration order. Consumed by the sitemap. */
export const DEAL_CATEGORY_SLUGS: string[] = Object.keys(CATEGORIES);
