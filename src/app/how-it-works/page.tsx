    ...
    <section className="demo dark" id="stacked">
      ...
      <table className="power-table">
        ...
        <tbody>
          ...
          <tr><td className="feat">Dispute letters citing UK law</td><td className="them">—</td><td className="them">—</td><td className="them">—</td><td className="them">Templates</td><td className="them">Guide</td><td className="us">AI + law</td></tr>
