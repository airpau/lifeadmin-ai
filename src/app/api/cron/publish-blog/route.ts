...
<div style="max-width:600px;margin:0 auto;">
  ...
  <div style="background:#0a1628;padding:32px;">
    ...
    <p style="color:#34d399;font-weight:700;margin:0 0 8px;">${parsed.title}</p>
    ...
    <a href="https://paybacker.co.uk/blog/${topic.slug}" style="display:inline-block;background:#34d399;color:#0a1628;font-weight:600;padding:10px 20px;border-radius:6px;text-decoration:none;font-size:13px;margin-top:16px;">View Post</a>
