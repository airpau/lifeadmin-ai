...
const SAMPLES: Record<string, string> = {
  ...
  mobile:
    'I am writing to dispute the out-of-contract price increase applied to my tariff on [date] and to give notice of my intention to terminate my contract without early exit fees under Ofcom\'s General Conditions (Conditions C1.14 to C1.17). Following your notification of a mid-contract price increase, I am entitled under Condition C1.15 to terminate at no additional cost, and under Condition C1.17 no early termination charge is payable. I gave notice on [date] within the required one-month window...',
  parking:
