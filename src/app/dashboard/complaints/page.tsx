...
const ISSUE_TYPE_LABELS: Record<string, string> = {
  ...
  train_delay_compensation: 'Train Delay Compensation',
...
const CATEGORY_ALIAS: Record<string, string> = {
  ...
  train: 'train_delay_compensation',
  train_delay: 'train_delay_compensation',
  rail: 'train_delay_compensation',
  rail_delay: 'train_delay_compensation',
