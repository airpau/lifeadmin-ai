...
interface Lead {
  ...
  // 'dispute_pro' is retained here (read-only) because historical rows can
  // still hold it; nothing writes it any more.
  // Original note:
  // a pricing-page click can now intend Household.
