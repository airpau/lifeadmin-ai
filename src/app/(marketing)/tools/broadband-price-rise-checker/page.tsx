  ...
  return (
    <ToolShell
      ...
      honesty={{
        ...
        paragraphs: [
          'This is worth being precise about, because we have seen free tools get it wrong and it matters. A mid-contract price rise on broadband or mobile is governed by the Ofcom General Conditions of Entitlement, specifically Conditions C1.14 to C1.17. It is not governed by section 9 of the Consumer Rights Act 2015, and it is not governed by the 14-day cancellation right in the Consumer Contracts Regulations 2013.',
      ...
      explainers={[
        ...
        },
        {
          ...
          paragraphs: [
            ...
            'Write to the provider rather than ringing. Say which contract you are on, that the increase is a contractual modification under Ofcom General Condition C1.14, and that you are exercising the right to terminate at no additional cost under Condition C1.15, with no early termination charge payable under Condition C1.17. Ask it to confirm in writing which contract term it says permits the increase and where that term was disclosed to you before you signed. That question does most of the work.',
            'If the provider refuses, ask for a deadlock letter. After six weeks, or on a deadlock letter, you can take it free of charge to whichever approved ADR scheme your provider belongs to, either the Communications Ombudsman or CISAS. Check which one before you file.',
      ...
      faqs={[
        {
          ...
          a: 'Only if the rise was a modification rather than something disclosed before you signed. Ofcom General Condition C1.14 requires at least one month’s notice of any contractual modification, Condition C1.15 gives you the right to terminate at no additional cost, and Condition C1.17 confirms no early termination charge is payable. If the exact new price was stated in pounds and pence before you signed, there is generally no exit right.',
        },
        {
          q: 'Does the Consumer Rights Act 2015 help with a price rise?',
          a: 'Not in the way it is usually cited. Section 9 is the satisfactory quality right and applies to goods, not to services like broadband and mobile. The service provisions are sections 49 to 52 and they concern how the service is performed, not the price. The rule that governs a mid-contract price rise is the Ofcom General Conditions, Conditions C1.14 to C1.17.',
        },
        {
        ...
        },
        {
          ...
          a: 'Ask for a deadlock letter. After six weeks from your written complaint, or immediately on a deadlock letter, you can take the case free of charge to the approved ADR scheme your provider belongs to, which is either the Communications Ombudsman or CISAS. Check which one before filing, because neither can hear a case about the other’s members. Ofcom cut this wait from eight weeks to six with effect from 8 April 2026.',
        },
      ]}
      cta={{
        title: 'Have a ground? Cite it correctly.',
        body: 'Complaints teams close letters that quote the wrong statute. Paybacker drafts yours against the Ofcom General Conditions, keeps a record of what you sent and when, and runs the six-week clock so you know exactly when the ombudsman route opens.',
      }}
    />
  );
}
