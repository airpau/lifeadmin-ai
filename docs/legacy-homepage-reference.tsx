/**
 * LEGACY HOMEPAGE — PRESERVED FOR REFERENCE ONLY.
 *
 * This is the pre-April-2026 Tailwind homepage that was live at `/` until
 * PR 87 cut the route over to the v2 redesign. It is NOT imported, NOT
 * rendered, and NOT part of any build. It exists here so we can:
 *
 *   1. Quickly check what copy/links/sections existed on the old page
 *   2. Port anything the v2 redesign is missing (SEO links, CTAs,
 *      logged-in detection, trial banner, founding-member claim flow,
 *      PostHog capture events, etc.)
 *   3. Roll the route back in an emergency by copying this content
 *      back into `src/app/page.tsx` (or `git revert <PR 87 merge sha>`)
 *
 * Do NOT edit this file to change what ships. It's a snapshot.
 *
 * Original path: src/app/page.tsx
 * Archived from: commit 6428de57 (April 2026, pre-PR-87)
 */

// @ts-nocheck
// eslint-disable
// --- snapshot begins below ---
