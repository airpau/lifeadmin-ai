...
## Critical
- [ ] Full site audit fixes — 9 tasks from Cowork audit - Fix all 14 bugs found in Cowork full site audit (28 Mar): (1) Delete 3 duplicate disputes [still @Paul — production data delete] + add dedup prevention [~PR#509 — 2026-07-26, closed the last unguarded path: Telegram palert_draft_], (2) Fix Profile active disputes count (shows 38, should be 10) [~PR#504], (3) Fix Overview complaints count (shows 14, should be 10) [~PR#503], (4) Fix Income Breakdown duplicate Other categories + Spending Breakdown triple Other [~PR#501], (5) Add 14 new merchant_rules for clean display names, (6) Hide Switch and Save for council tax/loans/water [done PR#322], (7) Fix Monthly Trends chart month labels [~PR#508], (8) Rename Money Hub Subscriptions to Regular Payments [done PR#499 — 2026-05-27], (9) Fix guided tour tooltip [done], (10) Fix subscription count consistency [done — verified on master 2026-07-26, shared helper src/lib/subscriptions/active-count.ts used by Overview, Subscriptions and Money Hub]. Full prompt provided to Paul for Claude Code. (@Claude Code)
