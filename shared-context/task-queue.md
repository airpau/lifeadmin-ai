...
## Critical
- [ ] Full site audit fixes — 8 remaining tasks from Cowork audit - (1) Delete 3 duplicate disputes + add dedup prevention, (2) Fix Profile active disputes count (shows 38, should be 10), (3) Fix Overview complaints count (shows 14, should be 10), (4) Fix Income Breakdown duplicate Other categories + Spending Breakdown triple Other, (5) Add 14 new merchant_rules for clean display names, ~~(6) Hide Switch and Save for council tax/loans/water~~ [~PR#322], (7) Fix Monthly Trends chart month labels, (8) Rename Money Hub Subscriptions to Regular Payments, (9) Fix guided tour tooltip, (10) Fix subscription count consistency. (@Claude Code)
