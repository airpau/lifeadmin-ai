...
- [x] Fix URL routing: /dashboard/disputes and /dashboard/overview return 404 (Verified resolved on 2026-05-03 by sprint runner. /dashboard/disputes/page.tsx is the live disputes page (3,190 lines) and /dashboard/overview/page.tsx already redirects to /dashboard. Both routes resolve, no 404s.) (@Claude Code)
...
- [~PR#453] FCA COMPLIANCE follow-up: Replace Net Position KPI with Savings Rate on Annual Insights - Same pattern as the Money Hub fix. /dashboard/insights/annual headline row was still rendering Net position as a £ value. PR swaps it for a "Savings rate" % card with YoY delta derived from yoy.previousIncome/previousSpend. (PR created 2026-05-03)
