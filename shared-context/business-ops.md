...
## Company
- **Name:** Paybacker LTD (UK registered)
- **Founded:** March 2026
- **Contact:** hello@paybacker.co.uk
- **Founder:** Paul

## Revenue
- **Pricing:** Free / Essential £4.99/mo (£44.99/yr) / Pro £9.99/mo (£94.99/yr)
- **MRR:** ~£100 (test accounts only)
- **Revenue streams:** Subscriptions (primary), Awin affiliate commissions (secondary)

## Partnerships
- **Awin:** Publisher 2825812, Advertiser 125502. Waiting Oscar sign-off on test integration.
- **Lebara:** Deals with promo codes live on deals page
- **CJ Affiliate:** Planned (British Gas)

---

# DEFINITIVE MARKETING STRATEGY (v2 — 26 March 2026)
## This is the single source of truth. Replaces all earlier playbooks.

### LAUNCH STATUS: PRE-LAUNCH (~2 April 2026)
All campaigns must be CREATED IN PAUSED/DRAFT STATE. Nothing goes live until Paul approves after blockers clear.

---

## 1. BUDGET MODEL
- **Starting monthly budget:** £5,000
- **Reinvestment:** 80% of MRR reinvested into marketing each month
- **Budget cap:** £18,000/mo (never exceed this)
- **Ramp-up factors:** Month 1 = 25% efficiency, M2 = 50%, M3 = 75%, M4+ = 100%
- **Target:** £100K+ MRR by Month 12

### Budget Allocation Per Month
| Channel | % of Budget | M1 (£5K) | M4+ Example (£8K) |
|---------|------------|----------|-------------------|
| Influencers (TikTok nano/micro) | 40% | £2,000 | £3,200 |
| Google Ads (Search) | 20% | £1,000 | £1,600 |
| Meta Ads (FB + IG) | 15% | £750 | £1,200 |
| TikTok Spark Ads | 10% | £500 | £800 |
| SEO Content | 10% | £500 | £800 |
| Tools & Software | 5% | £250 | £400 |

### Key Assumptions
- Signups per £1 spent: 0.52 (influencer-led blended average)
- Free-to-paid conversion rate: 8.5%
- Monthly churn: 2.5%
- Viral coefficient: 0.22 (referrals)
- Paid/free mix: 60% Essential (£4.99), 40% Pro (£9.99)
- Average revenue per paying user: £6.99/mo

---

## 2. GOOGLE ADS STRATEGY (20% of budget)

### API Access
- **Access Level:** Explorer (awaiting Basic upgrade)
- **Developer Token:** jCSfgPvX1M1zrWb92a3Zyw
- **Customer ID:** 390-589-8717
- **Daily Ops Limit:** 2,880/day
- **Status:** CREATE ALL CAMPAIGNS IN PAUSED STATE

### Campaign 1: Complaint Letters (Highest Intent)
- **Type:** Search campaign
- **Daily budget:** £15 (£450/mo)
- **Bidding:** Target CPA £8, start with Maximise Conversions
- **Location:** United Kingdom only
- **Language:** English
- **Ad Group 1 — Energy Complaints:**
  - Keywords: "complain about energy bill", "overcharged by british gas", "energy bill too high complaint", "how to complain to energy ombudsman", "energy company overcharge refund"
  - Match type: Phrase match
  - Headlines (max 30 chars each): "Overcharged on Energy Bills?" | "AI Complaint Letter in 60 Secs" | "Free Energy Bill Checker" | "Get Your Money Back Today" | "Paybacker — Fight Overcharges" | "Energy Refund Made Simple" | "Check If You're Overpaying" | "AI-Powered Bill Analysis" | "Stop Overpaying on Energy" | "Complaint Letter Generator" | "Used by 1000s Across the UK" | "Free to Try — No Card Needed" | "Trusted UK Money App" | "Save £200+/Year on Bills" | "AI Finds Your Overpayments"
  - Descriptions (max 90 chars each): "Paybacker scans your bills and writes complaint letters using AI. Free to start." | "Our AI has helped UK consumers reclaim thousands in energy overcharges." | "Connect your bank, we'll find where you're overpaying. Takes 2 minutes." | "Join thousands of UK households saving money with AI-powered bill checking."
- **Ad Group 2 — Flight Delay Claims:**
  - Keywords: "flight delay compensation", "claim flight delay refund", "flight cancelled compensation uk", "eu flight delay rights"
  - Headlines: "Flight Delayed or Cancelled?" | "Claim Up to £520 Compensation" | "AI Writes Your Claim Letter" | "Free Flight Delay Checker" | "Know Your Rights Instantly" | "EU Flight Compensation UK"
  - Descriptions: "Paybacker checks if you're owed compensation and writes the claim letter for you." | "Delayed flight? Our AI generates a legal complaint letter in under 60 seconds."
- **Ad Group 3 — General Complaints:**
  - Keywords: "how to complain to a company", "consumer rights complaint letter", "template complaint letter uk", "consumer ombudsman complaint"
  - Headlines: "Need to Complain to a Company?" | "AI Complaint Letter Generator" | "Professional Letters in 60 Secs" | "Free UK Consumer Tool"
  - Descriptions: "Tell us the issue, our AI writes a professional complaint letter using UK consumer law." | "Stop wasting hours on hold. Paybacker generates legally-worded complaint letters instantly."

### Campaign 2: Subscription Management (High Volume)
- **Type:** Search campaign
- **Daily budget:** £12 (£360/mo)
- **Bidding:** Target CPA £8
- **Ad Group 1 — Cancel Subscriptions:**
  - Keywords: "how to cancel subscriptions", "cancel unused subscriptions", "find forgotten subscriptions", "subscription tracker app", "stop wasting money on subscriptions"
  - Headlines: "Forgotten Subscriptions?" | "Find & Cancel in Minutes" | "AI Subscription Scanner" | "Stop Paying for What You Don't Use" | "Bank-Connected Sub Tracker" | "Save £100s on Unused Subs"
  - Descriptions: "Paybacker connects to your bank and finds every subscription — even ones you forgot about." | "Our AI detected an average of £312/year in unused subscriptions per user."
- **Ad Group 2 — Money Saving Apps:**
  - Keywords: "best money saving app uk", "budget app uk", "personal finance app uk", "money management app", "save money on bills app"
  - Headlines: "Best Money Saving App UK" | "AI-Powered Finance App" | "Save Money Automatically" | "Free Bill Checking Tool" | "Smart Money Management"
  - Descriptions: "Paybacker combines budgeting, bill checking, and complaint resolution in one AI-powered app." | "Connect your bank and let AI find savings you're missing. Free to try, no card needed."

### Campaign 3: Energy Savings (Seasonal, High CPC Value)
- **Type:** Search campaign
- **Daily budget:** £10 (£300/mo)
- **Bidding:** Target CPA £10
- **Ad Group 1 — Energy Switching:**
  - Keywords: "cheapest energy tariff", "switch energy supplier", "compare energy deals", "reduce energy bills", "energy bill too high"
  - Headlines: "Energy Bill Too High?" | "AI Finds Cheaper Tariffs" | "Switch & Save on Energy" | "Daily Tariff Monitoring" | "Compare Energy Deals Free"
  - Descriptions: "Paybacker monitors energy tariffs daily and alerts you when a cheaper deal is available." | "Our Energy Tariff Monitor checks the market every day so you don't have to."

### Google Ads Extensions (Apply to ALL campaigns)
- **Sitelinks:** "Write Complaint Letter" → /dashboard/complaints | "Check Your Subscriptions" → /dashboard/subscriptions | "Energy Tariff Monitor" → /dashboard/scanner | "View Pricing" → /pricing
- **Callouts:** "Free to Start" | "No Card Required" | "UK Consumer Law AI" | "Bank-Level Security" | "Used by 1000s"
- **Structured Snippets:** Types: "Complaint Letters, Bill Checking, Subscription Tracking, Energy Monitoring, Budget Planning"

### Google Ads Automation (Claude Code cron — build now)
- **Daily (7am):** Pull metrics via API → write to Supabase `daily_ad_metrics` table + MCP business-ops
- **Weekly (Monday 6am):** Auto-optimise:
...
## 3. META ADS STRATEGY (15% of budget)

### API Access
- **System User:** Paybacker Poster (ID: 61578647176991)
- **Token:** Never-expiring system user token (in env)
- **Page ID:** 1056645287525328
- **Instagram ID:** 17841440175351137
- **Ad Account:** Assigned with full control
- **API Version:** v25.0
- **Status:** CREATE ALL CAMPAIGNS IN PAUSED STATE

### Pre-requisites (Claude Code must verify/build)
1. Meta Pixel installed on paybacker.co.uk (all pages)
2. Conversions API (CAPI) server-side events: PageView, SignUp, StartTrial, Purchase
3. fbclid capture on signup (store to user profile)
4. Custom Audiences already built (4 segments: all visitors, signup incomplete, free users, churned)
5. Let pixel learn for 1-2 weeks after launch before scaling spend

### Campaign 1: Conversions — New User Acquisition
- **Objective:** Conversions (optimise for SignUp event)
- **Daily budget:** £20 (£600/mo at full scale)
- **Audience:** UK, 22-55, interests: personal finance, money saving, budgeting, Martin Lewis, MoneySavingExpert
- **Placements:** Facebook Feed, Instagram Feed, Instagram Stories, Reels
- **Ad Set 1 — Problem Awareness:**
  - Creative angle: "The average UK household overpays £500/year on bills and subscriptions"
  - Format: Single image (dark navy background, mint accent, stat in large text)
  - CTA: Sign Up
  - Landing page: paybacker.co.uk
- **Ad Set 2 — Solution Awareness:**
  - Creative angle: "Paybacker connects to your bank and finds every overpayment automatically"
  - Format: Carousel (3 cards: Connect Bank → AI Scans → Get Money Back)
  - CTA: Learn More
  - Landing page: paybacker.co.uk
- **Ad Set 3 — Social Proof (enable after 50+ real users):**
  - Creative angle: User testimonial / savings amount
  - Format: Video or static with quote
  - CTA: Sign Up

### Campaign 2: Retargeting — Convert Visitors
- **Objective:** Conversions (optimise for StartTrial or Purchase)
- **Daily budget:** £5 (£150/mo)
- **Audience:** Custom Audience — visited site but didn't sign up (7-day window)
- **Exclusion:** Already signed up
- **Ad Set 1 — Urgency:**
  - Creative: "You visited Paybacker — here's what you're missing"
  - Format: Single image showing savings dashboard
  - CTA: Sign Up
- **Ad Set 2 — Free Trial:**
  - Creative: "Try Paybacker free — no card needed"
  - Format: Single image
  - CTA: Sign Up

### Meta Ads Automation (Claude Code cron — build now)
- **Daily (7am):** Pull Meta Ads metrics via Marketing API → Supabase `daily_ad_metrics` + MCP
- **Weekly (Monday 6am):** Auto-optimise:
  - CPA < £6 → increase budget +20%
  - CPA > £12 → pause ad set
  - CTR < 0.8% → flag creative for replacement
  - Log all changes to MCP

---

## 4. INFLUENCER STRATEGY (40% of budget — LARGEST CHANNEL)

### Approach
- Focus on TikTok nano creators (5K-20K followers) and micro creators (20K-100K)
- UK personal finance niche: money saving, budgeting, bills, frugal living
- Pay per video: £150-400 for nano, £400-800 for micro
- Each creator gets a unique referral link for tracking: paybacker.co.uk/?ref=CREATORNAME
- Target: 5-10 creators per month in M1-M3, scale to 15-20 in M4+

### Content Brief for Creators
- Style: Authentic, not scripted. "I found this app that..." format
- Key message: Connect your bank, it finds where you're overpaying, free to try
- Must include: Screen recording of the app, genuine reaction to findings
- CTA: Link in bio to their unique referral URL
- Avoid: Making it feel like an ad, scripted testimonials, unrealistic claims

### Creator Research (Pre-Launch — Cowork handles this)
- Search TikTok for: #moneysaving #budgetuk #personalfinance #frugalliving #savemoney
- Log to Influencer Tracker spreadsheet: name, handle, followers, engagement rate, contact, estimated cost
- Draft DM templates (don't send until launch)

### Tracking
- Each creator gets UTM: ?utm_source=influencer&utm_medium=tiktok&utm_campaign=CREATORNAME
- Plus referral code: ?ref=CREATORNAME
- Claude Code tracks signups per creator in Supabase
- Weekly ROI report per creator (Cowork morning briefing)

---

## 5. SEO STRATEGY (10% of budget)

### Already Live
- 5 SEO landing pages (energy disputes, flight delays, etc.)
- Dynamic sitemap
- Google Search Console verified
- Blog with Perplexity-researched articles

### Claude Code To Build
- 4 new SEO blog articles (1500+ words each, FAQ schema markup):
  1. "How to Complain About Your Energy Bill and Get a Refund (2026 Guide)"
  2. "Flight Delay Compensation UK: Your Complete Guide to Claiming"
  3. "The Best Money Saving Apps UK 2026: Honest Comparison"
  4. "Hidden Subscriptions: How to Find and Cancel Services You Forgot About"
- Each article must: target long-tail keywords, include FAQ schema, internal links to signup, alt text on images
- These CAN go live immediately (no blocker)
...
### Accounts
- **Facebook:** facebook.com/profile.php?id=61579563073310 (Page ID: 1056645287525328)
- **Instagram:** instagram.com/paybacker.co.uk (Business ID: 17841440175351137)
- **X (Twitter):** x.com/PaybackerUK — @PaybackerUK
- **TikTok:** tiktok.com/@paybacker.co.uk
- **LinkedIn:** linkedin.com/company/112575954 (needs vanity URL)

### Automation Status
- Facebook + Instagram: AUTOMATED via Casey agent (Meta API, system user token)
- X/Twitter: PENDING — awaiting API keys from Paul, then Claude Code adds to Casey
- TikTok: MANUAL for now — future Content Posting API integration
- LinkedIn: MANUAL for now — future company page API integration

### Content Pillars (Casey posts 1-2x daily)
1. Money-saving tips (40%) — practical advice, bill-checking tips
2. Product features (25%) — what Paybacker does, how-to content
3. UK consumer rights (20%) — know your rights, complaint templates
4. Social proof (15%) — user stories, savings stats (when available)

### Branding
- Colours: Navy-950 #0A1628, mint-400 #34D399, orange-400 #FB923C
- Font: Plus Jakarta Sans
- Tone: Friendly, trustworthy, never salesy
- Casey generates images via fal.ai with mint/navy branding

---

## 7. REFERRAL STRATEGY (Viral Coefficient Target: 0.22)

### Current State
- Basic referral links exist (users get 1 free month per referral)
- Needs upgrading to dual-sided reward system

### Claude Code To Build
- **Referrer reward:** £5 account credit per successful paid referral
- **Referee reward:** £5 off first month (effectively free first month on Essential)
- Database: `referrals` table (referrer_id, referee_id, status, reward_paid, created_at)
- API: POST /api/referrals/claim, GET /api/referrals/stats
- Dashboard widget: "Invite friends, earn £5 each"
- Email trigger: Send referral reminder at Day 7 and Day 14 after signup
- Unique referral URLs: paybacker.co.uk/?ref=USERID

---

## 8. PR & MEDIA STRATEGY (Free — high impact)

### Gmail Drafts Ready (DO NOT SEND until product live + tested)
1. **MSE Deals Team** — submit via contact form + press office pitch
2. **Guardian Money** — Patrick Collinson (patrick.collinson@guardian.co.uk) — consumer story angle
3. **BBC Money Box** — Kevin Peachey (@PeacheyK) — cost-of-living angle
4. **Which? Press Office** — externalaffairs@which.co.uk — product review request

### Other Targets
- Podcasts: Cash Chats, Meaningful Money, All Things Money
- Fintech press: FinTech Magazine, Finextra, AltFi
- Approach: Paul as guest / founder story angle

### MSE WARNING
- DO NOT use MSE Forum for promotion (strict moderation, instant ban risk — Paul confirmed)
- Use editorial/press pitch route only

### PR Expected Value
- One MSE feature article: estimated 5,000-15,000 signups
- One Guardian article: estimated 2,000-5,000 signups
- BBC Money Box mention: estimated 3,000-8,000 signups
- Probability-weighted: ~£15K+/mo MRR contribution (bridges £69K paid channel to £100K+ total)

---

## 9. EMAIL AUTOMATION (Already built — verify working)

### Welcome Sequence (5 emails, mint/navy branding)
1. Welcome + bank connection prompt (immediate)
2. Feature walkthrough — subscriptions (Day 1)
3. Feature walkthrough — complaints (Day 3)
4. Feature walkthrough — scanner + deals (Day 5)
5. Upgrade prompt with social proof (Day 7)

### Retention
- Weekly Money Digest (Monday 7am)
- Churn prevention: 7-day inactive, 14-day inactive, pre-renewal value summary
- Energy Tariff Monitor alerts (daily)

---

## 10. TRACKING & ATTRIBUTION (Claude Code must build/verify)

### Required
- UTM capture on signup: utm_source, utm_medium, utm_campaign → user profile
- gclid capture (Google Ads click ID) → user profile
- fbclid capture (Meta click ID) → user profile
- Referral code capture: ref= parameter → referrals table
- Supabase table: `daily_ad_metrics` (date, platform, campaign, impressions, clicks, conversions, spend, cpa)
- Supabase table: `signup_attribution` (user_id, utm_source, utm_medium, utm_campaign, gclid, fbclid, ref_code, created_at)

### Reporting
- Daily: ad metrics pulled at 7am, written to Supabase + MCP
- Weekly: full channel analysis, budget recommendations (Cowork Monday briefing)
- Monthly: P&L, actuals vs forecast, channel ROI breakdown
...
### 2026-04-28 08:12:45 - social with Facebook+Instagram
Posted post_id 07 (theme=dispute-letter) to FB=ok (post 122109506930985435), IG=ok (media 18367633264206106). FB image: https://kcxxlesishltdmfctlmo.supabase.co/storage/v1/object/public/social-images/paybacker-post-07-20260423-221750.jpg. IG image: same Supabase URL (FB user token unavailable in handoff-notes/env, so fbcdn workaround skipped — IG accepted the Supabase URL directly this time). Caption starts: "This is a real Paybacker-drafted letter. 28 seconds to gener"
**Follow-up:** Note: IG accepted the Supabase URL today without the fbcdn workaround. If future runs fail, restore the long-lived FB user token to handoff-notes.md so the unpublished-photo fbcdn trick is available again.
